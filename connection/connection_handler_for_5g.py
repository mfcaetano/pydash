# -*- coding: utf-8 -*-
"""
@author: Marcos F. Caetano (mfcaetano@unb.br) 02/06/2022

@description: PyDash Project

The ConnectionHandlerFor5g is a Singleton class implementation

The class responsible to retrieve segments in the web server.
Also it implements a traffic shaping approach using 5G data 
traffic as a landmark.
"""
...
class ConnectionHandlerFor5g(SimpleModule):
